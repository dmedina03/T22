...
namespace Persistence.Migrations
{
    ...
    [Migration("20230915175338_initialMigration")]
            ...
            modelBuilder.Entity("Domain.Models.Parametro.Parametro", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IdParametro = 1L,
                            BEstado = true,
                            DtFechaActualizacion = new DateTime(2023, 9, 15, 12, 53, 38, 499, DateTimeKind.Local).AddTicks(7507),
                            DtFechaCreacion = new DateTime(2023, 9, 15, 12, 53, 38, 499, DateTimeKind.Local).AddTicks(7487),
                        ...
                        new
                        {
                            IdParametro = 2L,
                            BEstado = true,
                            DtFechaActualizacion = new DateTime(2023, 9, 15, 12, 53, 38, 499, DateTimeKind.Local).AddTicks(7511),
                            DtFechaCreacion = new DateTime(2023, 9, 15, 12, 53, 38, 499, DateTimeKind.Local).AddTicks(7510),
                        ...
                        new
                        {
                            IdParametro = 3L,
                            BEstado = true,
                            DtFechaActualizacion = new DateTime(2023, 9, 15, 12, 53, 38, 499, DateTimeKind.Local).AddTicks(7513),
                            DtFechaCreacion = new DateTime(2023, 9, 15, 12, 53, 38, 499, DateTimeKind.Local).AddTicks(7512),
                        ...
                        new
                        {
                            IdParametro = 4L,
                            BEstado = true,
                            DtFechaActualizacion = new DateTime(2023, 9, 15, 12, 53, 38, 499, DateTimeKind.Local).AddTicks(7514),
                            DtFechaCreacion = new DateTime(2023, 9, 15, 12, 53, 38, 499, DateTimeKind.Local).AddTicks(7513),
