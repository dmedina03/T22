...
namespace Aplication.Services.T22.SolicitudServices
{
    public interface ISolicitudService : ICreateService<SolicitudDTORequest>, IGetService<SolicitudDTOResponse>
    {
        ...
        /// <returns>Lista de solicitudes</returns>
        Task<ResponseBase<List<SolicitudBandejaSolicitudesDTOResponse>>> GetSolicitudesBandejaValidador(string? UsuarioAsignadoId);
        /// <summary>
        ...
        /// <returns>Lista de solicitudes</returns>
        Task<ResponseBase<List<SolicitudBandejaSolicitudesDTOResponse>>> GetSolicitudesBandejaCoordinador(string? UsuarioAsignadoId);
        /// <summary>
        ...
        /// <returns>Lista de solicitudes</returns>
        Task<ResponseBase<List<SolicitudBandejaSolicitudesDTOResponse>>> GetSolicitudesBandejaSubdirector(string? UsuarioAsignadoId);
